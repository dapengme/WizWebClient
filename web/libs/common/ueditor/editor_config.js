...
(function () {
    ...
    var tmp = window.location.pathname;
        URL = '/libs/common/ueditor/';//window.UEDITOR_HOME_URL||tmp.substr(0,tmp.lastIndexOf("\/")+1).replace("_examples/","").replace("website/","");//这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:"/api/document/images"             //图片上传提交地址
        ...
        ,minFrameHeight:document.documentElement.clientHeight - 155  // 最小高度,默认320
